...
- (id)initWithFrame:(CGRect)frame numberOfStar:(int)number
{
    ...
    if (self) {
        ...
        self.starBackgroundView = [self buidlStarViewWithImageName:@"star_blank"];
        self.starForegroundView = [self buidlStarViewWithImageName:@"star_fill"];
...
- (UIView *)buidlStarViewWithImageName:(NSString *)imageName
{
    ...
    {
        UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageWithContentsOfFile: [[NSBundle mainBundle] pathForResource: imageName ofType: @"png"]]];
